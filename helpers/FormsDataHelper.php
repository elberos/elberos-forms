...
class FormsDataHelper
{
	...
	public static function get_forms_settings_table_name()
	{
		global $wpdb;
	...
	{
		global $wpdb;
		$forms_settings_table_name = static::get_forms_settings_table_name();
	...
	// Decode DATA keys
	public static function decode_data_key($form_id, $key)
	{
